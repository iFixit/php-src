...
void tokenizer_register_constants(INIT_FUNC_ARGS) {
	...
	REGISTER_LONG_CONSTANT("T_ECHO_ESCAPE", T_ECHO_ESCAPE, CONST_CS | CONST_PERSISTENT);
	...
	REGISTER_LONG_CONSTANT("T_OPEN_TAG_WITH_ECHO_ESCAPE", T_OPEN_TAG_WITH_ECHO_ESCAPE, CONST_CS | CONST_PERSISTENT);
...
char *get_token_type_name(int token_type)
{
	switch (token_type) {
		...
		case T_ECHO_ESCAPE: return "T_ECHO_ESCAPE";
		...
		case T_OPEN_TAG_WITH_ECHO_ESCAPE: return "T_OPEN_TAG_WITH_ECHO_ESCAPE";
